...
const UserNotificationComponent = (props) => {
  ...
  const toggleSwitch01 = () =>
    setIsEnabled01((previousState) => !previousState);
  const [isEnabled02, setIsEnabled02] = React.useState(false);
  const toggleSwitch02 = () =>
    setIsEnabled02((previousState) => !previousState);
  const [isEnabled03, setIsEnabled03] = React.useState(false);
  const toggleSwitch03 = () =>
    setIsEnabled03((previousState) => !previousState);
  const [isEnabled04, setIsEnabled04] = React.useState(false);
  const toggleSwitch04 = () =>
    setIsEnabled04((previousState) => !previousState);
