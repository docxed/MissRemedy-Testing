...
const UserInputComponent = (props) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.columnGrid}>
        <View style={styles.separator}>
          <Text style={styles.label}>เลขบัตรประจำตัวประชาชน</Text>
          <TextInput
      ...
      <View style={styles.columnGrid}>
        <View style={styles.separator}>
          <Text style={styles.label}>โรงพยาบาล</Text>
          <TextInput
            style={styles.inputFull}
      ...
      <View style={styles.columnGrid}>
        <View style={styles.separator}>
          <Text style={styles.label}>รหัสผู้ป่วย HN</Text>
          <TextInput
            style={styles.input}
      ...
      <View>
        ...
        >
          <Text style={styles.bTextLogin}>ยืนยัน</Text>
        </TouchableOpacity>
